...
class TestApiSupportNotificationFilterCreate(BaseTestProfile):
    ...
    def setUp(self):
        ...
        self.create_notification_filter_url = reverse('api_support_notification_filter_list_create')
    ...
    def _create_notification_filter(self):
        ...
        self.assertEqual(set(response.data.keys()),
                         {'id', 'name', 'profile', 'services', 'instance_states', 'when'})
    ...
    def test_cannot_post_notification_filter_on_another_profile(self):
        ...
        self._create_notification_filter()
        self.assertFalse(InstanceNotification.objects.exclude(id=self.support_notification_filter_test_3.id).filter(profile=self.superuser_2.profile).exists())
