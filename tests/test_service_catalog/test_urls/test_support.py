    ...
    def test_support_views(self):
        testing_view_list = [
            TestingGetContextView(
                ...
                perm_str_list=['service_catalog.list_support'],
            ),
            TestingGetContextView(
                url='service_catalog:support_create',
                perm_str_list=['service_catalog.add_support'],
            ...
            TestingGetContextView(
                ...
                perm_str_list=['service_catalog.view_support'],
                url_kwargs={'instance_id': self.support_test.instance.id, 'pk': self.support_test.id},
            ),
            TestingPostContextView(
                url='service_catalog:support_details',
                perm_str_list=['service_catalog.add_supportmessage'],
                url_kwargs={'instance_id': self.support_test.instance.id, 'pk': self.support_test.id},
                data={
                    'content': 'message'
                }
            ...
            TestingGetContextView(
                ...
                perm_str_list=['service_catalog.change_supportmessage'],
