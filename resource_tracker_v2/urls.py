...
urlpatterns = [
    ...
    # Transformer CRUD
    path('resource_group/<int:resource_group_id>/attribute/', views.TransformerListView.as_view(), name='transformer_list'),
    path('resource_group/<int:resource_group_id>/attribute/create/', views.TransformerCreateView.as_view(), name='transformer_create'),
    path('resource_group/<int:resource_group_id>/attribute/<int:attribute_id>/edit/', views.TransformerEditView.as_view(), name='transformer_edit'),
    path('resource_group/<int:resource_group_id>/attribute/<int:attribute_id>/delete/', views.TransformerDeleteView.as_view(), name='transformer_delete'),
    # Transformer AJAX
    path('resource_group/load-resource-group-attribute/', views.ajax_load_attribute, name='ajax_load_attribute'),

    # Resource CRUD
    path('resource_group/<int:resource_group_id>/resource/', views.ResourceListView.as_view(), name='resource_list'),
    path('resource_group/<int:resource_group_id>/resource/create/', views.ResourceCreateView.as_view(), name='resource_create'),
    path('resource_group/<int:resource_group_id>/resource/<int:pk>/edit/', views.ResourceEditView.as_view(), name='resource_edit'),
    path('resource_group/<int:resource_group_id>/resource/<int:pk>/delete/', views.ResourceDeleteView.as_view(), name='resource_delete'),
    # Resource particular urls
    path('resource_group/<int:resource_group_id>/resource/<int:pk>/move/', views.ResourceMoveView.as_view(), name='resource_move'),
    path('resource_group/<int:resource_group_id>/resource/delete/', views.resource_group_resource_bulk_delete, name='resource_bulk_delete')
]
