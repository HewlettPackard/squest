...
urlpatterns = [
    ...
    path('approval-workflow/', ApprovalWorkflowListCreate.as_view(), name='api_approval_workflow_list_create'),
    path('approval-workflow/<int:pk>/', ApprovalWorkflowDetails.as_view(), name='api_approval_workflow_details'),
    path('approval-workflow/<int:approval_workflow_id>/approval-step/', ApprovalStepListCreate.as_view(),
