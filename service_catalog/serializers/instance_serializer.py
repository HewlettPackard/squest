...
from profiles.api.serializers.billing_group_serializers import BillingGroupInstanceSerializer
...
class InstanceSerializer(serializers.ModelSerializer):
    ...
    billing_group = BillingGroupInstanceSerializer(read_only=True)
