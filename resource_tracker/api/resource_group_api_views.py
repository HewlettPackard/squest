...
from resource_tracker.api.serializers.resource_group_serializer import ResourceGroupSerializer, ResourceSerializer, \
...
class ResourceGroupResourceListCreate(generics.ListCreateAPIView):
    permission_classes = [IsAdminUser]
